...
const CertCard = ({ cert, onClick, index }) => (
  <motion.div
    ...
    className="cursor-pointer rounded-2xl p-5 flex flex-col gap-4 select-none border border-black/10 bg-white/80 shadow-md hover:shadow-lg transition-shadow duration-300"
  >
    {/* Icon */}
...
const Certifications = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-16" id="certifications">
      <div className="mb-10">
        <p className="text-[#555] text-sm uppercase tracking-widest mb-1">Lo que he logrado</p>
        <h2 className="text-[#1a1a1a] font-bold text-4xl">Certificaciones.</h2>
      </div>
